...
- Maltraitance (sous-rubrique "Nature") : il s'agit de mauvais traitements infligés à des personnes vulnérables, comme par exemple les enfants, les personnes âgées ou les incapables majeurs. Elle peut être physique, ou psychique.
- Institution ( sous-rubrique "Contexte") : cette case est à cocher lorsque la victime était placée **pendant les faits** dans un établissement public ou privé, quelque soit le lieu (hôpital, EHPAD, foyer, etc.)
