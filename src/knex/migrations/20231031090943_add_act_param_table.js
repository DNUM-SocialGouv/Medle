...
exports.up = function (knex) {
    return knex.schema.createTable("summary_act_parameters", function (table) {
      table.increments("id")
    ...
    .then(function() {
        ...
        return knex("summary_act_parameters").insert(transformedData);
      })
      .then(async () => {
  await knex.raw("create index acts_ponderation_idx on summary_act_parameters using gin (ponderation JSONB_PATH_OPS);")
      });   
  }
  
  exports.down = async function (knex) {
    await knex.raw("drop index acts_ponderation_idx;")
    return knex.schema.dropTable("summary_act_parameters")
  }