...
exports.up = `
    ...
    with all_hospitals_by_day as (
        select calendar.entry::date as day, name, id, unnest(array['Victime (vivante)', 'Personne décédée', 'Gardé.e à vue', 'Personne pour âge osseux (hors GAV)', 'Examen pour OFPRA', 'Autre activité/Personne retenue', 'Autre activité/Examen lié à la route', 'Autre activité/IPM', 'Autre activité/Assises', 'Autre activité/Reconstitution', 'Vivants (tous profils)']) as type
