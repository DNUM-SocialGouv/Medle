...
var tarteaucitron = {
   ...
   addService: function(serviceId) {
      ...
      var html = "",
         ...
         isNavigating =
            hostRef === hostname && window.location.href !== tarteaucitron.parameters.privacyUrl ? true : false,
         isAutostart = !service.needConsent ? true : false,
         isWaiting = cookie.indexOf(service.key + "=wait") >= 0 ? true : false,
         isDenied = cookie.indexOf(service.key + "=false") >= 0 ? true : false,
         isAllowed = cookie.indexOf(service.key + "=true") >= 0 ? true : false,
         isResponded =
            cookie.indexOf(service.key + "=false") >= 0 || cookie.indexOf(service.key + "=true") >= 0 ? true : false,
         isDNTRequested =
         ...
         if (type === "box") {
            ...
            if (
               ...
               tarteaucitron.userInterface.css(
                  ...
                  "marginRight",
                  scrollbarWidthParent - scrollbarWidthChild + scrollbarMarginRight + "px",
               )
            }
         ...
         tarteaucitron.addScript(url, "", function() {
            if (document.getElementById(id) !== null) {
               document.getElementById(id).innerHTML +=
                  "<span style='display:none'>&nbsp;</span>" + tarteaucitron.makeAsync.buffer
