...
Pour vous aider dans votre démarche, vous trouverez ici <a href="https://www.cnil.fr/fr/modele/courrier/exercer-son-droit-dacces" style={{ color: "#376FE6" }}>Exercer son droit d'accès</a>, un modèle de courrier élaboré par la CNIL.
...
<table>
	...
	<tr><td>Microsoft Azure</td><td>France</td><td>Hébergement</td><td><a href="https://privacy.microsoft.com/fr-fr/privacystatement" style={{ color: "#376FE6" }}>Privacy Statement</a></td></tr>
</table>
...
- <a href="https://www.cnil.fr/fr/cookies-traceurs-que-dit-la-loi" style={{ color: "#376FE6" }}>Cookies & traceurs : que dit la loi ?</a>
- <a href="https://www.cnil.fr/fr/cookies-les-outils-pour-les-maitriser" style={{ color: "#376FE6" }}>Cookies : les outils pour les maîtriser</a>
